...
export const register = async (req, res, next) => {
  try {
    ...
    // Fire-and-forget: never block registration on email
    sendWelcomeEmail({ name: user.name, email: user.email, role: "student" }).catch((err) =>
      console.error("[MAILER] sendWelcomeEmail threw:", err.message)
    );
