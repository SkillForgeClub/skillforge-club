...
import imgAripakanavya from '../assets/profile photos (File responses)/Aripakanavya.png';
import imgChandrikaBylapudi from '../assets/profile photos (File responses)/Chandrika Bylapudi.png';
import imgChaitanya from '../assets/profile photos (File responses)/Chaitanya Pamidi.jpeg';
import imgCharmi from '../assets/profile photos (File responses)/Charmi.png';
import imgHarshi from '../assets/profile photos (File responses)/harshitha.jpeg';
import imgHarsha from '../assets/profile photos (File responses)/Harsha.png';
import imgHarshith from '../assets/profile photos (File responses)/Harshith.png';
import imgJureddiJaishnavi from '../assets/profile photos (File responses)/Jureddi Jaishnavi.jpg';
import imgKKarthik from '../assets/profile photos (File responses)/kunduru karthik.jpeg';
import imgJoshika from '../assets/profile photos (File responses)/Joshika.jpeg';
import imgKartikTummalapalli from '../assets/profile photos (File responses)/Kartik Tummalapalli.jpg';
import imgKundanaLam from '../assets/profile photos (File responses)/Kundana Lam.jpg';
import imgLalasaSomadhula from '../assets/profile photos (File responses)/Lalasa Somadhula.jpg';
import imgNavya from '../assets/profile photos (File responses)/Navya.jpg';
...
import imgVainavi from '../assets/profile photos (File responses)/Vainavi.jpg';
import imgVaishnaviPathsamatla from '../assets/profile photos (File responses)/Vaishnavi Pathsamatla.jpg';
import imgVenkateshAmudalapalli from '../assets/profile photos (File responses)/Venkatesh Amudalapalli.jpg';
import imgVinay from '../assets/profile photos (File responses)/Vinay_.jpg';
import imgYashwant from '../assets/profile photos (File responses)/Yashwant_.jpg';
import imgGayathriGuvvala from '../assets/profile photos (File responses)/gayathri guvvala.jpg';
import imgTharunKumar from '../assets/profile photos (File responses)/tharun.jpeg';
        ...
        {selectedMember && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative bg-slate-950 border border-white/10 w-full max-w-4xl rounded-3xl overflow-hidden shadow-[0_0_50px_rgba(6,182,212,0.15)] flex flex-col md:flex-row z-10 max-h-[90vh] md:max-h-none"
            >
              ...
              <div className="w-full md:w-1/2 h-64 sm:h-80 md:h-[520px] bg-slate-900 relative overflow-hidden flex items-center justify-center">
