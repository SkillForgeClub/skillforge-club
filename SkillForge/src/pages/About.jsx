            ...
            <motion.div variants={fadeInUpVariants} className="lg:w-1/2 grid grid-cols-2 gap-4 relative z-10 w-full">
              {[
                ...
                <motion.div
                  ...
                  className="bg-slate-950/50 backdrop-blur-md border border-white/8 p-6 rounded-3xl transition-all duration-300 flex flex-col items-center text-center shadow-lg hover:shadow-cyan-500/10 cursor-default"
                >
