...
const InputField = ({ icon: Icon, type, placeholder, value, onChange }) => {
  ...
  return (
    <div className="relative">
      <Icon className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none" size={18} />
      <input
        ...
        onChange={onChange}
        required
        className="field-input pl-12 pr-12 py-3.5 font-medium"
      />
      {isPassword && (
        <button
          type="button"
          onClick={() => setShow(!show)}
          className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-white transition-colors p-1 -m-1 rounded-md"
