          ...
          {tabs.map(({ id, label, icon: Icon, color, gradient: tGrad }) => {
            ...
            return (
              <button
                ...
                className={`flex-1 py-3 px-3 text-sm md:text-base font-bold rounded-xl transition-colors duration-300 flex items-center justify-center gap-2 relative overflow-hidden ${
