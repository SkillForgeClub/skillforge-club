...
const ProfileView = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="bg-[#1e293b]/80 border border-white/5 rounded-[3rem] p-5 sm:p-8 md:p-14 shadow-2xl flex flex-col md:flex-row items-center gap-8 md:gap-12 relative overflow-hidden">
