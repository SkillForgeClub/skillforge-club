        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-12">
          ...
          >
            <a 
              ...
              className="bg-slate-950/40 backdrop-blur-xl border border-white/10 p-6 sm:p-8 rounded-2xl flex flex-col items-start gap-4 shadow-xl hover:border-cyan-500/30 transition-all duration-300 group"
            >
              ...
              {/* Social Media Links inside Email Card */}
              <div className="flex flex-wrap gap-3 mt-4 pt-4 border-t border-white/10 w-full">
                <a href="https://linkedin.com/company/skillforge-viit" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-3 py-2 rounded-xl bg-white/5 hover:bg-white/10 text-gray-300 hover:text-white border border-white/5 transition-all duration-200">
                  <Linkedin className="w-4 h-4 text-blue-400" /> LinkedIn
                </a>
                <a href="https://youtube.com/@skillforge_viit?si=CNGftmeEVKPEv-AY" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-3 py-2 rounded-xl bg-white/5 hover:bg-white/10 text-gray-300 hover:text-white border border-white/5 transition-all duration-200">
                  <Youtube className="w-4 h-4 text-red-500" /> YouTube
                </a>
                <a href="https://www.facebook.com/share/1AT2CbvTYd/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-3 py-2 rounded-xl bg-white/5 hover:bg-white/10 text-gray-300 hover:text-white border border-white/5 transition-all duration-200">
                  <Facebook className="w-4 h-4 text-blue-500" /> Facebook
                </a>
                <a href="https://www.instagram.com/skillforge_club?igsh=MWF0a2FieXF3M2g2eQ==" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-3 py-2 rounded-xl bg-white/5 hover:bg-white/10 text-gray-300 hover:text-white border border-white/5 transition-all duration-200">
                  <Instagram className="w-4 h-4 text-pink-400" /> Instagram
                </a>
              </div>
            </a>

            <div className="bg-slate-950/40 backdrop-blur-xl border border-white/10 p-6 sm:p-8 rounded-2xl flex flex-col sm:flex-row items-start gap-4 shadow-xl">
