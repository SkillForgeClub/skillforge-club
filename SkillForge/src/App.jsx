...
import { LayoutDashboard, BookOpen, Rocket, BookOpenCheck, BrainCircuit, MessageSquare, User, Users, ClipboardCheck, Code2, CalendarCheck, Settings, UserSquare, FolderOpen, Award } from 'lucide-react';

const studentMenu = [
  { title: 'Dashboard', path: '/student-portal', icon: <LayoutDashboard /> },
  { title: 'My Domains', path: '/student-portal/domains', icon: <BookOpen /> },
  { title: 'Resources', path: '/student-portal/resources', icon: <FolderOpen /> },
  { title: 'Assignments', path: '/student-portal/assignments', icon: <ClipboardCheck /> },
  { title: 'Events', path: '/student-portal/events', icon: <CalendarCheck /> },
  { title: 'Certificates', path: '/student-portal/certificates', icon: <Award /> },
